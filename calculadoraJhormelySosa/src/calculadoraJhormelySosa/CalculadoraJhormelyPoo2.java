package calculadoraJhormelySosa;
...
public class CalculadoraJhormelyPoo2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CalculadoraJhormelyPoo2 frame = new CalculadoraJhormelyPoo2();
	 ...
	 * Create the frame.
	 */
	public CalculadoraJhormelyPoo2() {
